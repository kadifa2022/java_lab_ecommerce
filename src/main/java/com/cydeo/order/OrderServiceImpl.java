...
public class OrderServiceImpl implements OrderService{
    ...
    public String placeOrder(Cart cart) {
        ...
        switch (paymentType) {
            case 1:
                CheckoutService customBalanceCheckoutService = new CustomerBalanceCheckoutServiceImpl();
                checkoutResult = customBalanceCheckoutService.checkout(cart.getCustomer(), amountAfterDiscount);
                break;
            case 2:
