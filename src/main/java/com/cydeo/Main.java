...
import static com.cydeo.StaticConstants.DISCOUNT_LIST;
import static com.cydeo.StaticConstants.ORDER_LIST;
...
public class Main {
        ...
        while (true) {
            ...
            switch (menuSelection) {
                ...
                case 4:
                    ...
                    System.out.println("Witch Account would you like to add");
                ...
                case 5:
                    ...
                    while (true) {
                        ...
                        for (Product product : StaticConstants.PRODUCT_LIST) {
                            try {
                                System.out.println("id:" + product.getId() + "price:" + product.getPrice() + "" +
                                        ...
                                        "stock:" + product.getRemainingStock() + "product delivery due:" + product.getDeliveryDueDate());
                            } catch (Exception e) {
                        ...
                        System.out.println("Do you want to add more products. Type Y for adding more, N for exit");
    ...
    private static void printOrderByCustomerId(UUID costumerId){
        for(Order order : ORDER_LIST){
            if(order.getCustomerId().toString().equals(costumerId.toString())){
                System.out.println("Order status:" + order.getOrderStatus()+ "order amount"
